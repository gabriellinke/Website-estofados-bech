...
export async function seed(knex: Knex)
{
    await knex('descriptions').insert([
        { product_id: 1, description:'Um sofá pronto para te acompanhar na hora de ler seu livro favorito ou tirar uma soneca pós-almoço, tudo graças à função retrátil - que você escolher a melhor posição do assento, aninhando seu corpo e esticando as pernas de forma muito confortável.' },
        ...
        { product_id: 3, description:'O estofado macio é o principal destaque dessa cadeira, mas a ergonomia também chama a atenção: além do encosto ser mais alto, o ângulo na região lombar é perfeito pois se adapta ao formato do corpo de maneira aconchegante.' },
